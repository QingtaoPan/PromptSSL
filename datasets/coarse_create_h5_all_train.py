...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_num", type=int, default=215,
    ...
    parser.add_argument("--total_num", type=int, default=215,  # ------------------------------------------------------------- 修改数据量的时候吧要修改 10-->215 -----------------------------------------------
                        help="the total subjects number of test dataset, training dataset, and validation dataset.")

    args = parser.parse_args()

    data_root_dir = args.data_root_dir  # 数据路景
    ...
    mrDir = os.path.join(data_root_dir, 'fine/in/nii/original_mr')
    maskDir = os.path.join(data_root_dir, 'fine/in/nii/mask')
    foldIndDir = os.path.join(data_root_dir, 'fine')
    outDir = os.path.join(data_root_dir, 'fine/in/h5py')
