...
def load_data(filePath, return_weight=True, batch_size=32, num_workers=1, shuffle=True, transformer_config=None):
    ...
    train_data = f['train']
    val_data = f['val']
    train_set = H5Dataset(data=train_data, transformer_config=transformer_config, return_weight=return_weight, phase='train')  # return_weight-->False
    ...
    #                                  shuffle=False)
    return training_data_loader, val_data_loader, f
