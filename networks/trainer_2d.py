...
class Trainer:
    ...
    def __init__(self, model, model_teacher, optimizer, lr_scheduler, loss_criterion,
                 eval_criterion_disc, eval_criterion_miou, device, train_loader, val_loader, checkpoint_dir,
    ...
    def train(self, train_loader):
        ...
        for i, t in enumerate(train_loader):
            ...
            mr, weight, target_all, filename = self._split_training_batch(t)
            # print('----------------------------------')
            ...
            target_weak = target_teacher[0] + target_text  # [b, 20, 256, 512]
            ...
            output, loss = self._forward_pass_train(mr=mr, mask=target, weight=weight)  # output:[16, 20, 256, 512] output, loss = self._forward_pass_train(mr=mr, mask=target, weight=weight)  # output:[16, 20, 256, 512]
